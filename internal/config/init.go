...
# defaults to "main"; path defaults to "pipelines". Pipeline bundles carry
# agent names, runtimes, and template references — never template prompt
# bodies (#2204 removed template distribution).
[pipeline_remote]
repo = ""
ref = ""
path = ""
