...
// measures.
func openRetainedTranscriptLog(home, jobID, runtimeName string, store *db.Store) (*retainedTranscript, error) {
	...
	return newRetainedTranscript(file, jobID, runtimeName, store), nil
}
