...
func printMemoryUsage(w io.Writer) {
	...
	fmt.Fprintln(w, "  gitmoot memory retire [--pending] --provenance-prefix P [--agent NAME] [--dry-run] [--yes] [--json]")
	...
	fmt.Fprintln(w, "  retire        bulk-retire confirmed memory, or pending observations with --pending, by provenance prefix")
