// Package githubtest provides test doubles for internal/github.
//
// NoopClient lived in internal/github/client.go, where it was 31 methods of
// production-compiled code with zero production callers: every user is a _test
// file. deadcode reported all 31 as unreachable, which was accurate and pointed
// at the wrong remedy - the type is needed, just not by the binary. Moving it
// here keeps every consumer working while taking it out of the shipped package
// (#1757).
package githubtest
